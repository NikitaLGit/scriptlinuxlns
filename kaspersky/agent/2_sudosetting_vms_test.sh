...
echo "Проверьте в новом файле /etc/sudoers.test, чтобы не было окружение PATH в директиве Default env_keep!"
echo "Если с sudoers.test все ок, то сделай 'mv sudoers.test sudoers'"
